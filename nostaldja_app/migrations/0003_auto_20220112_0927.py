# Generated by Django 4.0.1 on 2022-01-12 14:27
from django.db import migrations

def seed(apps, schema_editor):
    Fad = apps.get_model('nostaldja_app', 'Fads')
    Decade = apps.get_model('nostaldja_app', 'Decades')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nostaldja_app', '0002_alter_decades_start_year'),
    ]
